...
def concat_review(review_list, musical_name):
    ...
    for i in review_list:
        re1 = pd.read_csv(f"C:/Users/1ayou/PycharmProjects/MLDA_Final-Project_Team1/data/reviews/{i}.csv")
    ...
    # csv 파일로 저장
    cc_review.to_csv(f"C:/Users/1ayou/PycharmProjects/MLDA_Final-Project_Team1/data/tot_review/review_{musical_name}.csv", index=True, sep=",", encoding="utf-8-sig")
    # 확인용 return
